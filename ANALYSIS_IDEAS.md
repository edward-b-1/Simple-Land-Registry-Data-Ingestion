...
| Bank of England base rate | date | Rate sensitivity of prices and volumes; spread between base rate and mortgage rates. |
| Bank of England quoted mortgage rates (2y/5y fixed at 75%/90% LTV, tracker, SVR — series IUMBV34, IUMB482, IUMBV42, IUMBV24, IUMTLMV; from 1995) and effective rates actually paid on new/outstanding mortgages (from 2004) | date (lag ~3 months to completion) | What buyers actually paid to borrow. Payment-to-income affordability (median price, 75% LTV, 25-year term at that month's rate ÷ median earnings). See `MORTGAGE_RATES.md`. |
| MLAR (BoE/FCA Mortgage Lenders & Administrators Return, quarterly from 2007) and BoE mortgage approvals (LPMVTVX, monthly) | quarter / month | Typical borrower profile (LTV band, income multiple, fixed vs variable, first-time-buyer share); approvals as a 2–3 month leading indicator of transaction volumes. |
