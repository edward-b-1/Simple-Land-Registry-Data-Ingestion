...
def main(recreate: bool):
    ...
    if recreate:
        LandRegistryBase.metadata.tables['land_registry_simple.pp_complete_metadata'].drop(engine)

    LandRegistryBase.metadata.tables['land_registry_simple.pp_complete_metadata'].create(engine)
